...
class Baloon():
    ...
    def update(self):
        self.bounce(rightShoulder)
        self.bounce(leftShoulder)
        self.bounce(rightElbow)
        self.bounce(leftElbow)
        self.bounce(rightKnee)
        self.bounce(leftKnee)
        self.bounce(rightAnkle)
        self.bounce(leftAnkle)
        self.bounce(nose)
